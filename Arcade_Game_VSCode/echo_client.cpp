...
static bool pause_button =  false;
...
int main() {
    ...
    while (!WindowShouldClose())
    {
        ...
        // do recvfrm(struct)
        // draw text to screen
        // rate limit (so many send/receives otherwise) - timer, multiples, etc.
        ...
        sendto(client_socket, &struct_to_send, sizeof(struct_to_send), 0, (struct sockaddr*)&serv_addr, serv_addr_len);
